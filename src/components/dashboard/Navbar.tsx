...
const Navbar = () => {
  ...
  const DropdownButton = ({
    ...
    <button
      ...
      className="group p-3 cursor-pointer bg-white border border-gray-200 rounded-full hover:bg-gray-100 transition duration-300 ease-in-out"
    >
      {isImage ? (
        <Image src="/vercel.svg" alt="Vercel Logo" width={21} height={21} />
      ) : (
        <Icon
          size={20}
  ...
  const ProfileIcon = ({ path }: { path: string }) => (
    <svg
    ...
    >
      <path fillRule="evenodd" clipRule="evenodd" d={path} fill="" />
    </svg>
  );
            ...
            <div className="absolute right-0 mt-2 w-56 bg-white shadow-lg rounded-md p-3 z-50">
              ...
              <ul className="flex flex-col gap-1 pt-4 pb-3 border-b border-gray-200 dark:border-gray-800">
                {[
                  ...
                  <li key={label}>
                    <DropdownItem
                      onItemClick={() => setDropdownOpen(null)}
                      tag="a"
                      href={href}
              ...
              <Button
                ...
                startIcon={<LogOut />}
                size="sm"
                className="w-full mt-3 cursor-pointer text-red-500 "
